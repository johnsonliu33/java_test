 ...
 */
public interface Actor<E> extends Statistical{
    void start();

    //asynchronous call
    default void receive(EventType eventType, Object data) {
    }

    default void receive(EventType eventType, Object data, String id, Long delay, Long interval) {
    }
    ...
    //synchronous call
    void handle(EventType eventType, Object data);
