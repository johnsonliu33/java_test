 ...
 */
public class ControllerAppHandler implements EventHandler<Event> {
    private static Logger log = LoggerFactory.getLogger(ControllerAppHandler.class);
    ...
    public void onEvent(Event event) {
        if (event.getData() instanceof ControllerRequest) {
            ...
            request.setOriginatingProcessor(ProcessorType.CONTROLLER_APP);
